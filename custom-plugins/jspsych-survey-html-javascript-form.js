...
jsPsych.plugins['survey-html-javascript-form'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      javascript: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: "Page script",
        default: '',
        description: "A script tag to append to the document when this trial executes"
      }
    }
  }
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.javascript !== '') {
      ...
      scriptTag.appendChild(document.createTextNode(trial.javascript));
