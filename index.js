...
var scale_life = [
  "Not at all like my life",
  "A little bit like my life",
...
var abuse_2 = {
  ...
  questions: [
    {prompt: `Answer this question only if you answered 'Physical abuse' or 'Psychological abuse' or 'Sexual abuse' to the previous question. <br>
              These episodes were caused by (please select all appropriate answers):`, 
      options: ["One or several people in my family", "One or several people outside my family"], name: 'childhood_abuse', required: true}
],
  };
...
var care = {
  type: 'survey-likert',
  questions: [
    {prompt: `          From your birth until you were 7 years old, how much did your father take care of you?          `, name: 'paternal_care', required: true, labels: paternal_care}
],
  };
...
var personal_striving = {
  ...
  preamble: `<br><br> One way to describe someone’s personality is to consider the purposes or goals that the person seems to be seeking in his or her everyday behavior. 
    ...
    <br><br>Trying to be physically attractive to others
    <br><br>Trying to persuade others that one is right
    <br><br>Trying to help others in need of help
    <br><br>Trying to seek new and exciting experiences
    <br><br>Trying to avoid being noticed by others
    <br><br>Trying to avoid feeling inferior to others
    ...
    <br>For example, a person might be “Trying to get others to like me” without necessarily being successful.
    <br>These strivings may be fairly broad, such as &#39;&#39;Trying to make others happy&#39;&#39; or more specific, as &#39;&#39;Trying to make my partner happy.&#39;&#39;
    <br>Also note that the strivings can be either positive or negative. That is, they may be about something you typically try to obtain or keep, or things that you typically try to avoid or prevent. 
    <br>For example, you might typically try to obtain attention from others, or you might typically try to avoid calling attention to yourself. 
    <br>You can see that this way of describing yourself is different from using trait adjectives (friendly, intelligent, honest). We do not want you to use trait adjectives. 
    <br>Since you may have never thought of yourself in this way before, think carefully about what we are asking you to do before you write anything down. 
    <br>We want you to provide us with a list of your strivings. Please write down at least 15 strivings in the spaces provided below. 
    <br>You may list additional strivings if you wish. Please keep your attention focused on yourself. 
    <br>Do not mentally compare the things that you typically do with what other people do. Think of yourself and your purposes alone. Be as honest and as objective as possible. 
    <br>Do not give simply socially desirable strivings or strivings which you think you &#39;&#39;ought&#39;&#39; to have.
    <br>You might find it useful to think about your goals in different domains of your life: work and school, home and family, social relationships, and leisure/recreation. 
    <br>Think about all of your desires, goals, wants, and hopes in these different areas.
...
var social_value_scale_2 = [   /////////////////////////////////////////////////////// make 4 more
  `You receive 
  <br>100   
  <br>50
  <br>Other receives`,
...
var guilt_proneness_scale = {
  ...
  <br>As you read each scenario, try to imagine yourself in that situation. 
  <br>Then indicate the likelihood that you would react in the way described.`,
  questions: [
    {prompt: `After realizing you have received too much change at a store, you decide to keep it because the sales clerk doesn&#39;t notice. <br>What is the likelihood that you would feel uncomfortable about keeping the money?`, name: 'gp_1', required: true, labels: scale_likely},
    ...
    {prompt: `At a coworker&#39;s housewarming party, you spill red wine on their new cream-colored carpet. You cover the stain with a chair so that nobody notices your mess. <br>What is the likelihood that you would feel that the way you acted was pathetic?`, name: 'gp_3', required: true, labels: scale_likely},
...
var pers_norm_reciprocity = {
  ...
  questions: [
    ...
    {prompt: `I ruminate for a long time when other people are treated better than me.`, name: 'own_dis_4', required: true, labels: scale_agre},
...
var pers_norm_reciprocity = {
  ...
  <br>While reading over the list, consider which ones tend to be most important to you and which tend to be least important to you. After familiarizing yourself with the list, 
  <br>rate the relative importance of each value to you as a guiding principle in your life.
  ...
  <br>Avoid using too many similar numbers. Work fairly quickly.`,
  questions: [
...
var debrief_3 = {
  ...
  const surveys = [    
    ...
    spon_donate,
    hexaco_1, //all broken up by 10 items
    hexaco_2,
    hexaco_3,
    hexaco_4,
    hexaco_5,
    hexaco_6,
    team_prosocial_motivation, // added teamwork scales
    org_citizenship_behavior_scale,
    teamwork_scale,
    life_history_1, //all rest is life history
    life_history_2,
    life_history_3,
    life_history_4,
    parent_birth,
